...
| **ÉPICO 3** | Inteligência Operacional: Precificação automática avançada (P3.1), Dashboard Executivo — DRE + fluxo de caixa, Relatórios financeiros | 🟡 **Em andamento — iniciado 07/09/2026.** Módulo P3.1 (Precificação automática) ✅ concluído; Módulo P3.2 (Relatórios financeiros) ✅ concluído — ver abaixo |
...
| **UI** — Vitrine (`/`) com layout incorreto | Product Owner, 13/09/2026 | Reportado pelo Product Owner como "layout errado", sem detalhamento ainda de qual elemento/breakpoint está incorreto — a especificação exata do que precisa mudar fica pendente de levantamento numa sessão dedicada antes de qualquer implementação. |
