import type { OccasionTagInput, ValidationError } from "@/lib/types";

const HEX_COLOR_RE = /^#[0-9A-Fa-f]{6}$/;

export function validateOccasionCreate(input: OccasionTagInput): ValidationError[] {
...
export function validateOccasionUpdate(
